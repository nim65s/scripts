...
[[ -f /etc/arch-release ]]   && sudo pacman -Syu --noconfirm git gvim fish openssh tinc python-pip rofi pass pcsc-tools ccid libusb-compat dunst msmtp-mta shellcheck dfc ripgrep fd khal khard vdirsyncer todoman
